...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    game_uuid: Attribute.UID & Attribute.Required;
    players: Attribute.JSON &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    player_uuid: Attribute.UID & Attribute.Required;
    ...
    friends: Attribute.JSON &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    active_games: Attribute.JSON &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
